...
<template>
  <main class="correct-app pa-4" aria-labelledby="page-title">
    <header class="page-header">
      <div class="page-brand"><div class="brand-icon"><VIcon icon="mdi-folder-refresh-outline" size="28" /></div><div><span class="eyebrow">MOVIEPILOT ORGANIZE SAFETY</span><h1 id="page-title">MP整理纠正</h1><p>按源文件中英文片名和可选年份纠正英文整理结果，源文件永久保留。</p></div></div>
